...
from app.adapters.api.main import to_ria08_model_input
from app.adapters.api.schemas import RIA08Input
...
def test_service_keeps_flat_contract_and_sorts_teacher_batch(trained_model) -> None:
    service = RIA08Service(trained_model)
...
def test_api_mapper_keeps_snapshot_fields_and_identity() -> None:
    ...
    assert to_ria08_model_input(payload) == {
        "student_id": "42",
        "student_name": "Ada",
        "intentos": 4,
        "errores": 3,
